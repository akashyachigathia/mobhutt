...
import com.mobhut.cart.Cart;
import com.mobhut.cart.CartService;
import com.mobhut.category.Category;
import com.mobhut.category.CategoryService;
import com.mobhut.product.Product;
import com.mobhut.product.ProductService;
import com.mobhut.user.User;
import com.mobhut.user.UserService;
import com.mobhut.userrole.UserRoleService;

@Controller
public class MobhutController {
		...
		else
		{
		   ...
		   for(User u:List)
		   {
				...
				us.insertUser(i);    	
				    	  ...
				    	  mav.addObject("Success", "User Added Succeessfully");
				    	  mav.addObject("User", new User());
